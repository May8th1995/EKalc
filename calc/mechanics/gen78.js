...
function calculateSMSS(gen, attacker, defender, move, field) {
    ...
    (0, util_2.checkKlutz)(attacker);
    (0, util_2.checkKlutz)(defender);
    ...
    if (move.named('Weather Ball')) {
        ...
        move.type = (0, items_1.getMultiAttack)(attacker.item);
    }
    ...
    if (gen.num === 7) {
        var bp = (0, util_2.pokeRound)((basePower * (0, util_2.chainMods)(bpMods)) / 0x1000);
    ...
    basePower = (0, util_2.OF16)(Math.max(1, (0, util_2.pokeRound)((basePower * (0, util_2.chainMods)(bpMods)) / 0x1000)));
    var attack;
    ...
    attack = (0, util_2.OF16)(Math.max(1, (0, util_2.pokeRound)((attack * (0, util_2.chainMods)(atMods)) / 0x1000)));
    var defense;
    ...
    defense = (0, util_2.OF16)(Math.max(1, (0, util_2.pokeRound)((defense * (0, util_2.chainMods)(dfMods)) / 0x1000)));
    ...
    if (isSpread) {
        baseDamage = (0, util_2.pokeRound)((0, util_2.OF32)(baseDamage * 0xc00) / 0x1000);
    }
    if (attacker.hasAbility('Parental Bond (Child)')) {
        baseDamage = (0, util_2.pokeRound)((0, util_2.OF32)(baseDamage * 0x400) / 0x1000);
    }
    var noWeatherBoost = defender.hasItem('Utility Umbrella');
    if (!noWeatherBoost && (field.hasWeather('Sun', 'Harsh Sunshine') &&
        move.hasType('Fire')) ||
        (field.hasWeather('Rain', 'Heavy Rain') && move.hasType('Water'))) {
        baseDamage = (0, util_2.pokeRound)((0, util_2.OF32)(baseDamage * 0x1800) / 0x1000);
        desc.weather = field.weather;
    }
    else if (!noWeatherBoost &&
        (field.hasWeather('Sun') && move.hasType('Water')) ||
        (field.hasWeather('Rain') && move.hasType('Fire'))) {
        baseDamage = (0, util_2.pokeRound)((0, util_2.OF32)(baseDamage * 0x800) / 0x1000);
        desc.weather = field.weather;
    }
    else if (!noWeatherBoost &&
